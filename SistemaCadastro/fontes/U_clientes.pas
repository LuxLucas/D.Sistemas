...
procedure TClientes.btn_imprimirClick(Sender: TObject);
begin
  with dm.sql_imprimir do
  begin
    close;
    sql.Clear;
    ...
    Begin
      sql.Add('Select * from cliente');
        ...
        begin
          ...
          ParamByName('id').Value:=StrtoInt(txt_impressao.text);
        end;
        open;
        dm.report.LoadFromFile(GetcurrentdIR+'\rel\relatorio.fr3');
...
begin
  txt_impressao.text:=inttostr(dm.sql_imprimirid.value);
end;
...
procedure TClientes.btn_buscartudoClick(Sender: TObject);
begin
  with dm.sql_con_cliente do
   begin
     close;
